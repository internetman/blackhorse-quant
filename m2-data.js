window.M2_DATA = {
  ...
  decision: {
    title: "待观察股票池：45 只",
    text: "8-10 盘中买点候选 3 只：新集能源、陕西煤业、卫星化学。必须等收盘站稳参考 Pivot 且明显放量，盘中信号不直接买。",
    nextFocus: "新集能源 / 陕西煤业 / 卫星化学",
    pivot: "未确认",
    distance: "—"
  },
  changes: [
    { time: "报价", text: "8-10 09:45 盘中报价已更新，45 只监控股全部取到东方财富实时行情。" },
    { time: "候选", text: "买点候选 3 只：新集能源、陕西煤业、卫星化学；均需等收盘与量能确认。" },
