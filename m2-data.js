window.M2_DATA = {
  ...
  market: {
    status: "🟡 震荡 / 分化",
    note: "本次用 8-6 收盘导入表维护待观察股票池；每日导出不同，已入池且未确认失效的股票继续保留为待复核。",
    stats: [
      { label: "观察池", value: "45 只" },
      { label: "当前合格", value: "32 只" },
      { label: "新进观察", value: "6 只" },
      { label: "待复核保留", value: "13 只" }
    ]
  },
  decision: {
    title: "待观察股票池：45 只",
    text: "8-6 收盘当前合格 32 只，相对上一观察池新进 6 只；13 只旧观察股收盘未出现，先保留待复核。当前仍不生成买入指令。",
    nextFocus: "亿联网络 / 卫星化学",
    pivot: "未确认",
    distance: "—"
  },
  changes: [
    { time: "观察池", text: "8-6 收盘有效观察 32 只；与既有观察池并集后，当前记录 45 只。" },
    { time: "新增", text: "收盘新进 / 重新确认 6 只：上纬新材、昀冢科技、兖矿能源、潞安环能、高乐股份、天娱数科。" },
    { time: "边界", text: "页面提供参考 Pivot 买点；只有收盘突破且明显放量才可能触发，当前仍不生成 B1/B2。" }
  ],
  candidates: [
    {
