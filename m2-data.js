window.M2_DATA = {
  ...
  market: {
    status: "🟡 震荡 / 分化",
    note: "本次用 8-5 收盘和 8-6 盘中两份导入表维护待观察股票池；每日导出不同，已入池且未确认失效的股票继续保留。",
    stats: [
      { label: "观察池", value: "39 只" },
      { label: "当前合格", value: "25 只" },
      { label: "新进观察", value: "11 只" },
      { label: "待复核保留", value: "14 只" }
    ]
  },
  decision: {
    title: "待观察股票池：39 只",
    text: "网站记录需要继续观察的股票；其中 25 只在 8-6 盘中仍满足硬条件，14 只从 8-5 收盘观察池保留待复核。当前没有买点触发。",
    nextFocus: "明泰铝业 / 卫星化学",
    pivot: "未确认",
    distance: "—"
  },
  changes: [
    { time: "观察池", text: "8-5 收盘合格 28 只，与 8-6 盘中合格 25 只取并集，当前记录 39 只。" },
    { time: "新增", text: "8-6 新进观察 11 只；8-5 已入池但 8-6 暂未确认的 14 只保留为待复核观察。" },
    { time: "边界", text: "观察池不是买点触发表；没有 RS、历史 OHLCV、Pivot 和收缩次数，不触发 B1/B2。" }
  ],
  candidates: [
    {
