window.M2_DATA = {
  asOf: "2026-08-10 盘中行情",
  selectionAsOf: "2026-08-06 收盘",
  snapshotAsOf: "2026-08-07",
  quoteGeneratedAt: "2026-08-10T09:45:06+08:00",
  market: {
    status: "🟡 震荡 / 分化",
    note: "观察池仍按 8-6 收盘维护；图形基准更新到 8-7 完成日K，本次只更新 8-10 盘中报价和买点分层。",
    stats: [
      { label: "观察池", value: "45 只" },
      { label: "5星可执行", value: "0 只" },
      { label: "4星确认中", value: "3 只" },
      { label: "贴近 Pivot", value: "6 只" },
      { label: "盘中上涨", value: "29 只" }
    ]
  },
  decision: {
    title: "待观察股票池：45 只",
    text: "8-10 盘中 5 星可执行为 0；4 星确认中 3 只：新集能源、陕西煤业、卫星化学。5 星才代表可下单，4 星必须等收盘站稳 Pivot、明显放量、止损位和仓位计划确认。",
    nextFocus: "4星确认中：新集能源 / 陕西煤业 / 卫星化学",
    pivot: "未确认",
    distance: "—"
  },
  changes: [
    { time: "报价", text: "8-10 09:45 盘中报价已更新，45 只监控股全部取到东方财富实时行情。" },
    { time: "星级", text: "5 星可执行 0 只；4 星确认中 3 只：新集能源、陕西煤业、卫星化学；均需等收盘与量能确认。" },
    { time: "盯盘", text: "贴近 Pivot 6 只：潞安环能、招商轮船、众生药业、九安医疗、北部湾港、新凤鸣。" },
    { time: "边界", text: "益生股份、海通发展偏热不追；旧观察池走强的美迪西、凯莱英、科伦药业仍先待复核。" }
  ],
  candidates: [
    {
